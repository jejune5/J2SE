...
public class CalendarDemo {
    public static void main(String[] args) {
        ...
        //获取月
        int month = nowTime.get(Calendar.MONTH); //月份是从0开始
        //获取日
