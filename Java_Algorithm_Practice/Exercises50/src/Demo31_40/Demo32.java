...
public class Demo32 {
    public static void main(String[] args) {
        ...
        System.out.println("请输入一个七位及以上的数：");
        long l = sc.nextInt();
